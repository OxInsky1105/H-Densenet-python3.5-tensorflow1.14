...
#proprecessing(image_path='../data/lits17_train/', save_folder='myTrainingData/')
#proprecessing(image_path='data/TestData/', save_folder='myTestData/')
print ("Generate liver txt ")
generate_livertxt(image_path='../data/lits17_train/', save_folder='myTrainingDataTxt/')
print ("Generate tumor txt")
generate_tumortxt(image_path='../data/lits17_train/', save_folder='myTrainingDataTxt/')
print ("Generate liver box ")
generate_txt(image_path='../data/lits17_train/', save_folder='myTrainingDataTxt/')
